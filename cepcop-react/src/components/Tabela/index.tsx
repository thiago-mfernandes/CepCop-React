            ...
            <Table>
                <THead>
                    <THeadTr>
                        ...
                        <THeadTh>{"Data de Cadastro"}</THeadTh>{" "}
                        {/* mockar tudo */}
                ...
                <TBody>
                    <TBodyTr>
                        ...
                        <TBodyTd dataLabel="Curso">
                            Clínica Psicanalítica Freud-Lacan"
                        </TBodyTd>
                        <TBodyTd dataLabel="Permissoes">
                            Gerenciar Superviores: SIM"
                        </TBodyTd>
                        <TBodyTd dataLabel="Data do Cadastro">
                            01/01/2022
                        </TBodyTd>
